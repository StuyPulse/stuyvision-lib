...
public abstract class VisionModule {
     ...
     * <br>
     * <b>Note:</b> The VisionGui class will automatically associate all known
     * VisionModules with it upon its initialization. Clients implementing
     * VisionModules need not call this method.
     * @param app
     *            the VisionGui GUI application
     */
    public void setGuiApp(VisionGui app) {
        this.app = app;
    }

    public boolean hasGuiApp() {
        return app != null;
    }
