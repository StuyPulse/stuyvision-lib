...
sudo apt-get -y install libavformat-dev libavutil-dev libswscale-dev make cmake-curses-gui g++ libv4l-dev libeigen3-dev libglew1.6-dev libgtk2.0-dev qt5-qmake qt5-default
